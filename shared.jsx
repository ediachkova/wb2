...
function SortableHeader({ label, column, sortCol, sortDir, onSort, align = 'left', borderLeft = false, highlight = false }) {
  ...
  return React.createElement('th', {
    ...
    style: { padding:'10px 14px', fontSize:12, fontWeight:600, color: active ? 'var(--accent)' : highlight ? 'var(--accent)' : 'var(--text-secondary)', textTransform:'uppercase', letterSpacing:.4, cursor:'pointer', userSelect:'none', textAlign:align, borderBottom:'1px solid var(--border)', whiteSpace:'nowrap', borderLeft: borderLeft ? '1px solid var(--border)' : undefined }
  },
