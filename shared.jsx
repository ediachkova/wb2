...
function SortableHeader({ label, column, sortCol, sortDir, onSort, align = 'left' }) {
  const active = sortCol === column;
  return React.createElement('th', {
    onClick: () => onSort(column),
    style: { padding:'10px 14px', fontSize:12, fontWeight:600, color: active ? 'var(--accent)' : 'var(--text-secondary)', textTransform:'uppercase', letterSpacing:.4, cursor:'pointer', userSelect:'none', textAlign:align, borderBottom:'1px solid var(--border)', whiteSpace:'nowrap' }
  },
