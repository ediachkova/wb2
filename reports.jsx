...
function FilterBar({ onFilter, extra }) {
  ...
  return React.createElement(Card, { style:{ padding:16, marginBottom:20 } },
    extra && React.createElement('div', { style:{ display:'flex', alignItems:'center', justifyContent:'space-between', flexWrap:'wrap', gap:12, paddingBottom:14, marginBottom:14, borderBottom:'1px solid var(--border)' } }, extra),
