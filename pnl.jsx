            ...
            visible.map((row, idx) => {
              ...
              return React.createElement('tr', {
                ...
                React.createElement('td', {
                  style:{ padding: rs.padding, fontSize: rs.fontSize, fontWeight: rs.fontWeight, color: rs.color, borderBottom:'1px solid var(--border)', position:'sticky', left:0, background: rs.bg !== 'transparent' ? rs.bg : 'var(--bg-card)', zIndex:1, minWidth:280 }
                },
