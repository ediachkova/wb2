          ...
          React.createElement('tbody', null,
            sorted.map((r, idx) => {
              ...
              return React.createElement('tr', { key: r.week, style:{ background: rowBg, transition:'background .12s' } },
                // Sticky week cell
                React.createElement('td', { style:{ position:'sticky', left:0, background: rowBg !== 'transparent' ? rowBg : 'var(--bg-card)', padding:'12px 14px', borderBottom:'1px solid var(--border)', borderRight:'1px solid var(--border)', zIndex:1, minWidth:240 } },
                ...
                cols.map(c => {
                  ...
                  return React.createElement('td', { key:c.key,
                    style: { padding:'12px', fontSize:13, textAlign:'right', borderBottom:'1px solid var(--border)', fontVariantNumeric:'tabular-nums', background:bg, fontWeight: isMargin ? 600 : 400, color: c.semantic ? marginColor(v) : 'var(--text-primary)', whiteSpace:'nowrap' }
                  },
